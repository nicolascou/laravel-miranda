...
function changeView(e) {
    if (media.matches) {
        ...
        const navbarDesktop = document
            .querySelector(".header__navbar")
            .cloneNode(true);
        navbarDesktop.classList.remove("d-none");

        headerDesktop.appendChild(
            document.querySelector(".header__main").cloneNode(true)
        );
        headerDesktop.appendChild(navbarDesktop);
        headerDesktop.appendChild(
            document.querySelector(".header__btns").cloneNode(true)
        );
        ...
        if (
            ...
            const aboutusFirstCol = document.querySelector(
                ".aboutus__first-col__first-col"
            );
            const aboutusSecondCol = document.querySelector(
                ".aboutus__first-col__second-col"
            );
            ...
            const menuButtons = document.querySelector(
                ".menu-section__menu__pagination"
            );
            ...
            document
                .querySelector(".menu-section__head")
                .appendChild(cloneMenuButtons);

            const menuOfMenu = document.querySelector(".menu-section__menu");
            const secondCol = document.createElement("div");
            secondCol.classList.add(
                "menu-section__menu__second-col",
                "only-desktop"
            );
            const option = document.querySelector(
                ".menu-section__menu__option"
            );
            ...
            clonedOption1.children[0].src = "img/fruit.jpg";
            clonedOption1.children[1].children[0].innerHTML = "Fruit Parfait";
            clonedOption2.children[0].src = "img/marmalade.jpg";
            clonedOption2.children[1].children[0].innerHTML =
                "Marmalade Selection";
            clonedOption3.children[0].src = "img/cheese.jpg";
            ...
            document
                .querySelector(".menu-section__bottom-slider")
                .classList.add("d-none-desktop");
            const menuBottomDesktop = document.createElement("div");
            menuBottomDesktop.classList.add(
                "menu-section__bottom-desktop",
                "only-desktop"
            );
            ...
            menuImg1.src = "img/menu-1.jpg";
            menuImg2.src = "img/menu-2.jpg";
            menuImg3.src = "img/menu-3.jpg";
        ...
        // Offers page
        if (
            document.querySelector(".hero__title").textContent === "Our Offers"
        ) {
            const offerPrices = document.querySelectorAll(
                ".offers-flex__box__prices"
            );
            const offerNewParents = document.querySelectorAll(
                ".offers-flex__box__first-row"
            );

            const buttonsOffer = document.querySelectorAll(
                ".offers-flex__box__btn"
            );
            const secondRowFirstCols = document.querySelectorAll(
                ".offers-flex__box__second-row__first-col"
            );
            ...
            popularRoomsFlex.classList.add(
                "popular-rooms__flex",
                "only-desktop"
            );
        ...
        if (
            ...
            relatedRoomsFlex.classList.add(
                "related-rooms__flex",
                "only-desktop"
            );
            const cards = document.querySelectorAll(".rooms-flex__box");
